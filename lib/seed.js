...
export const ROUTES = [
  {
    ...
    stops: [
      ...
      { t: "07:48", name: "Kundalahalli Colony", cap: 5, boarded: 0, absent: 0, status: "current" },
  ...
  },
  {
    ...
    stops: [
      ...
      { t: "07:34", name: "Bellandur Gate", cap: 8, boarded: 0, absent: 0, status: "current" },
  ...
  },
  {
    ...
    stops: [
      ...
      { t: "07:24", name: "Koramangala 5th", cap: 8, boarded: 8, absent: 0, status: "current" },
